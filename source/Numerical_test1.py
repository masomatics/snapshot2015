...
class DM_test:
        ...
        # old files that works. This is to be refactored

        #This uses real snapshot as the starting point, which is not realistic
        def __compute_A_and_B_old(self, snapshots, Nx, alpha, dsystem_old, seed):
